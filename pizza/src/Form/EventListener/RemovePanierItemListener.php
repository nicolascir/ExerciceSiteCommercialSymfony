...
class RemovePanierItemListener implements EventSubscriberInterface
{
    ...
    /**
     * supprime un acticle du panier baser sur la data envoyer part l'utilisateur
     *
    ...
    public function postSubmit(FormEvent $event): void
    {
        ...
        // cherche dans un tableau l'article ou le bouton remove est cliquer et le Supprime du panier
